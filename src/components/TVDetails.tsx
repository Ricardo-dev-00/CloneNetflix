          ...
          <div className="md:col-span-3 space-y-8">
            ...
            {tv.watch_providers?.results?.BR && (
              <div>
                ...
                {tv.watch_providers.results.BR.rent && (
                  <div className="mb-4">
                    <h4 className="text-sm text-gray-400 mb-2">Aluguel</h4>
                    <div className="flex flex-wrap gap-3">
                      {tv.watch_providers.results.BR.rent.map((provider) => (
                        <div
                          key={provider.provider_id}
                          className="bg-gray-800 rounded-lg px-4 py-2 text-sm font-semibold"
                        >
                ...
                {tv.watch_providers.results.BR.buy && (
                  <div className="mb-4">
                    <h4 className="text-sm text-gray-400 mb-2">Compra</h4>
                    <div className="flex flex-wrap gap-3">
                      {tv.watch_providers.results.BR.buy.map((provider) => (
                        <div
                          key={provider.provider_id}
                          className="bg-gray-800 rounded-lg px-4 py-2 text-sm font-semibold"
                        >
